...
export default function Sidebar({ onMoreAboutMe }: SidebarProps) {
  return (
    <motion.aside
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-purple-400 flex items-center justify-center font-extrabold text-lg text-[#0b0b0b] shrink-0 shadow-lg">
          AR
        </div>
      ...
      {/* Bio */}
      <p className="text-sm font-medium leading-relaxed text-[var(--bv-text-2)] m-0">
      ...
      <div className="flex gap-2">
        <a
          ...
          className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-sm text-[var(--bv-text-2)] transition-all duration-300 hover:bg-white/10 hover:text-white hover:border-white/20"
          aria-label="GitHub"
        >
